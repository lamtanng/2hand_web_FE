...
const useListProducts = () => {
  ...
  const getProducts = async (
    ...
    try {
      ...
      // const params = [page, limit, search, sort, quality, price, cateID, storeIDGroup, isApproved, isSoldOut];

      let res;
      if (search) {
        res = await productAPIs?.getAllProductByEmbedding(
          page,
          limit,
          search,
          sort,
        ...
        res = await productAPIs?.getAllProduct(
          page,
          limit,
          search,
          sort,
