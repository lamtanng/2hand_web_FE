...
const CartItem = ({group, groupCheckBoxHandler, checkedList, singleCheckBoxHandler}:
  {group: any,
  ...
  return (
    <div id="cart-item" key={group.shop.id} className="mb-5 w-full rounded-md bg-white shadow-sm">
      <Flex align="center" id="shop" gap={'large'} className="px-8 pt-6">
        <Checkbox value={group.shop.id} onChange={groupCheckBoxHandler} />
      ...
      {group.products.map((product: any) => (
        <div id="detail-container" className="px-8">
